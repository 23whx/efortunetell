  ...
  return (
    <div className="min-h-screen bg-[#FFFACD] flex flex-col items-center justify-center">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg border border-[#FF6F61] p-8 mb-8">
        <h1 className="text-3xl font-bold text-[#FF6F61] mb-8 text-center">管理员面板</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h2 className="text-xl font-bold text-[#FF6F61] mb-2">文章管理</h2>
          ...
          >
            ...
            <h2 className="text-xl font-bold text-[#FF6F61] mb-2">评论管理</h2>
          ...
          >
            ...
            <h2 className="text-xl font-bold text-[#FF6F61] mb-2">预约管理</h2>
